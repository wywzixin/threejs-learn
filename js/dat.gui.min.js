...
!(function (e, t) {
        ...
        Object.defineProperty(e, t, {
            get: function () {
                return 'RGB' === this.__state.space
                    ? this.__state[t]
                    : (V.recalculateRGB(this, t, n), this.__state[t]);
            },
            set: function (e) {
                'RGB' !== this.__state.space &&
                    (V.recalculateRGB(this, t, n), (this.__state.space = 'RGB')),
                    (this.__state[t] = e);
            },
        });
    }
        ...
        Object.defineProperty(e, t, {
            get: function () {
                return 'HSV' === this.__state.space
                    ? this.__state[t]
                    : (V.recalculateHSV(this), this.__state[t]);
            },
            set: function (e) {
            ...
            k.extend(n, {
                options: function (t) {
                    ...
                    if (k.isArray(t) || k.isObject(t)) {
                        ...
                        return (
                            n.remove(), p(e, n.object, n.property, { before: i, factoryArgs: [t] })
                        );
                    }
                },
                name: function (e) {
    ...
    function b(e) {
        ...
        U.addClass(e.domElement, 'has-save'),
            e.__ul.insertBefore(t, e.__ul.firstChild),
            U.addClass(t, 'save-row');
        ...
        if (
            ...
            (document.getElementById('dg-save-locally').style.display = 'block'),
                'true' === localStorage.getItem(f(e, 'isLocal')) &&
    ...
    function v(e) {
        ...
        function n() {
            U.removeClass(e.__closeButton, _e.CLASS_DRAG),
                        ...
                        return (
                            k.each(t.conversions, function (t, n) {
                                if (((O = t.read(e)), !1 === T && !1 !== O))
                                    return (
                                        (T = O), (O.conversionName = n), (O.conversion = t), k.BREAK
                                    );
                            }),
                            k.BREAK
                        );
    ...
    (V.recalculateRGB = function (e, t, n) {
        ...
        (V.recalculateHSV = function (e) {
            ...
            k.extend(e.__state, { s: t.s, v: t.v }),
                k.isNaN(t.h)
                    ? k.isUndefined(e.__state.h) && (e.__state.h = 0)
                    : (e.__state.h = t.h);
        }),
                ...
                return (
                    ...
                    U.bind(u.__background, 'mousedown', function (e) {
                        document.activeElement.blur(),
                            U.bind(window, 'mousemove', a),
                            U.bind(window, 'mouseup', l),
                            a(e);
                    }),
                    U.bind(u.__background, 'touchstart', function (e) {
                        1 === e.touches.length &&
                            (U.bind(window, 'touchmove', d), U.bind(window, 'touchend', c), d(e));
                    }),
                ...
                F(t, [
                    {
                        ...
                        value: function () {
                            ...
                            k.extend(this.__temp.__state, this.__color.__state),
                                (this.__temp.a = 1);
    ...
    var re = 'Default',
        ...
        _e = function e(t) {
            ...
            if (
                (Object.defineProperties(this, {
                    ...
                    closed: {
                        ...
                        set: function (t) {
                            (o.closed = t),
                                o.closed
                                    ? U.addClass(n.__ul, e.CLASS_CLOSED)
                                    : U.removeClass(n.__ul, e.CLASS_CLOSED),
                                this.onResize(),
                                n.__closeButton &&
                ...
                if (
                    ((o.closed = !1),
                    U.addClass(this.domElement, e.CLASS_MAIN),
                ...
                (this.__closeButton = document.createElement('div')),
                    ...
                    o.closeOnTop
                        ...
                        : (U.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM),
        ...
        k.extend(_e.prototype, {
                ...
                if (e.scrollable) {
                    ...
                    k.each(e.__ul.childNodes, function (t) {
                        ...
                        window.innerHeight - t - 20 < n
                            ...
                            : (U.removeClass(e.domElement, _e.CLASS_TOO_TALL),
            ...
            getSaveObject: function () {
                ...
                return (
                    ...
                    this.__rememberedObjects.length > 0 &&
                        ...
                        (e.remembered[this.preset] = w(this))),
                    (e.folders = {}),
            ...
            saveAs: function (e) {
                this.load.remembered ||
                    ((this.load.remembered = {}), (this.load.remembered[re] = w(this, !0))),
